			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="listingMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Our Hanoks</a>
					...
					<!-- Nav item Account -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="accounntMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</a>
            ...
            <div class="size">
				...
				<li class="nav-item ms-3 dropdown">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li><a class="dropdown-item" href="/customer/login.do"><i class="bi bi-bookmark-check fa-fw me-2"></i>Login</a></li>
						<li><a class="dropdown-item" href="/customer/regist.do"><i class="bi bi-heart fa-fw me-2"></i>Join-us</a></li>
						<li> <hr class="dropdown-divider"></li>
                ...
                <c:if test="${!empty login }">
                    ...
                    <a href="/customer/edit.do">MyPage</a>
