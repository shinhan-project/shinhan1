...
<header class="navbar-light header-sticky">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			<!-- Logo START -->
			<a class="navbar-brand" href="/admin/admin_dash.do"> <img
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll">
					...
					<!-- Nav item Contact -->
					<li class="nav-item"> <a class="nav-link" href="/admin/admin_dash.do">DashBoard</a></li>
				</ul>
			</div>
			<!-- Main navbar END -->
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div>
									<a class="h6 mt-2 mt-sm-0" href="#">${adminloginInfo.admin_name}</a>
						...
						<li><a class="dropdown-item" href="/admin/admin_logout.do"><i class="bi bi-bookmark-check fa-fw me-2"></i>Log-Out</a></li>
						<li> <hr class="dropdown-divider"></li>
